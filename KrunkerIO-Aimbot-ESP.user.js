...
<div class="dialog">${shouldShowAd ? `<big>Loading ad...</big>` : `<div class="close" onclick="this.parentNode.style.display='none';"></div>
    ...
    <br>
    <br>
	AD Free version by j-bond007.
	<br>
	<br>
    <div style="display: flex; justify-content: center;">
      <div class="btn" style="width: 200px;" onclick="window.open('https://github.com/j-bond007', '_blank')">Github</div>
    </div>
